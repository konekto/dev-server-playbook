...
registry_external_url 'https://{{gitlab_domain}}:4567'

registry_nginx['ssl_certificate'] = '/etc/letsencrypt/live/{{gitlab_domain}}/fullchain.pem'
registry_nginx['ssl_certificate_key'] = '/etc/letsencrypt/live/{{gitlab_domain}}/privkey.pem'
...
gitlab_rails['gitlab_shell_ssh_port'] = 78 
